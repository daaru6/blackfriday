        ...
        !(function (t) {
          ...
          t.fn.macawTabs = function (a) {
            ...
            return this.each(function () {
              const a = { parentThis: t(this), settings: n };
              e(a), c(a);
            });
          };
          const e = (t) => {
            ...
            a = (t) => {
              const { parentThis: e, settings: a } = t,
                s = e.find("> [role=tablist]");
              e.removeClass("vertical"),
                s.removeAttr("aria-orientation"),
                window.matchMedia(
                  `(max-width: ${a.autoVerticalOrientationMaxWidth})`
                ).matches &&
                  (e.addClass("vertical"),
                  s.attr("aria-orientation", "vertical"));
            },
            s = (e) => {
              const { parentThis: a, settings: s } = e,
                n = a.find("> [role=tablist] > [role=tab][aria-selected=true]"),
                i = t(`#${n.attr("aria-controls")}`);
              !0 === s.tabPanelTransitionLogic &&
                (s.tabPanelTransitionTimeout = setTimeout(() => {
                  i.addClass(s.tabPanelTransitionClass);
                }, s.tabPanelTransitionTimeoutDuration));
            },
            n = (e, a) => {
              const { parentThis: n, settings: i } = e;
              "true" !== a.attr("aria-selected") &&
                (((t) => {
                  const { parentThis: e, settings: a } = t,
                    s = e.find("> [role=tablist] > [role=tab]"),
                    n = e.find("> [role=tabpanel]");
                  s.attr("tabindex", "-1"),
                    s.attr("aria-selected", "false"),
                    !0 === a.tabPanelTransitionLogic &&
                      n.removeClass(a.tabPanelTransitionClass),
                    n.attr("hidden", "hidden");
                })(e),
                a.removeAttr("tabindex"),
                a.attr("aria-selected", "true"),
                t(`#${a.attr("aria-controls")}`).removeAttr("hidden"),
                s(e),
                i.onTabActivation.call({ parentThis: n, tab: a }));
            },
            i = (e, a, s) => {
              const { settings: i } = e;
              if ("prev" === s)
            ...
            r = (e) => {
              const { parentThis: a, settings: s } = e,
                i = a.find("> [role=tablist] > [role=tab]")[0];
              i.focus(), !0 === s.tabPanelAutoActivation && n(e, t(i));
            },
            o = (e) => {
              const { parentThis: a, settings: s } = e,
                i = a.find("> [role=tablist] > [role=tab]"),
                r = i[i.length - 1];
              r.focus(), !0 === s.tabPanelAutoActivation && n(e, t(r));
            },
            c = (a) => {
              const { settings: s } = a;
              !0 === s.autoVerticalOrientation &&
                t(window).resize(function () {
                  e(a);
                });
            },
            l = (e) => {
              const { parentThis: a } = e;
              a.find("> [role=tablist] > [role=tab]")
                .off("click")
                .on("click", function (a) {
            ...
            u = (e) => {
              const { parentThis: a } = e,
                s = a.find("> [role=tablist] > [role=tab]"),
                c = a.find("> [role=tablist]").attr("aria-orientation");
